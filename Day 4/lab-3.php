...
<head>
	...
	<script type="text/javascript">
		...
		*/
		var hideTimer = new Object();
		
		function setVisibility(objID, visibile){
			var obj = document.getElementById(objID);
			obj.style.visibility = (visibile) ? "visible" : "" ;
		}
		/*
		...
		*/
		function hideMenu(objID){
			...
			var obj = "setVisibility('" + objID + "', false)";
			hideTimer[objID] = setTimeout(obj, 500);
		}		
	</script>
</head>
...
<body>
	...
	<div id="menu">
		<a href="#" 
			...
			onmouseout="hideMenu('subMenu1')">Модуль 1</a>
		<a href="#" 
			onmouseover="showMenu('subMenu2')"
			onmouseout="hideMenu('subMenu2')">Модуль 2</a>
		<a href="#" 
			onmouseover="showMenu('subMenu3')"
			onmouseout="hideMenu('subMenu3')">Модуль 3</a>
	</div>
